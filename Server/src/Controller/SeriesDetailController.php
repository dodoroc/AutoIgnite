...
use Server\Domain\SeriesGetOneProcess;
use Server\Entity\SeriesId;

final class SeriesDetailController extends AbstractController
{
  private function doGet() : ResponseInterface
  {
    $proc = new SeriesGetOneProcess(new SeriesId($this->pathData['seriesId']));
    $proc->execute();
