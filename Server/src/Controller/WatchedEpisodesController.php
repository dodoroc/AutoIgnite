...
use Server\Domain\WatchedEpisodesBySeriesIdProcess;
use Server\Entity\SeriesId;

final class WatchedEpisodesController extends AbstractController
{
  private function doGet() : ResponseInterface
  {
    $proc = new WatchedEpisodesBySeriesIdProcess(new SeriesId($this->pathData['seriesId']));
    $proc->execute();
